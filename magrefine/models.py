...
class ContigID:
    ...
    @property
    def mylo_depth(self) -> str: 
        return self._header.mylo_depth

    def is_circular(self) -> bool: 
        return self._header.is_circular

    def is_duplicated(self) -> bool: 
        return self._header.is_duplicated
...
class Mag:
    ...
    def completeness(self): 
        return float(self._data[ 'Completeness' ])

    @property
    def contamination(self): 
        return float(self._data[ 'Contamination' ])

    @property
    def contig_n50(self): 
        return self._data[ 'Contig_N50' ]

    @property
    def gc_content(self): 
        return float(self._data[ 'GC_Content' ])

    @property
    def max_contig_length(self): 
        return self._data[ 'Max_Contig_Length' ]

    @property
    def genome_size(self): 
        return self._data[ 'genome_size' ]

    @property
    def average_coverage(self): 
        return self._data[ 'average_coverage' ]

    @property
    def total_contigs(self): 
        return self._data[ 'Total_Contigs' ]

    @property
    def trna_counts(self): 
        return self._data[ 'tRNA counts' ]
    ...
    @property
    def red_value(self): 
        return self._data[ 'red_value' ]

    def has_16s_rrna(self): 
        return self._data[ '16S_rRNA' ]

    def has_23s_rrna(self): 
        return self._data[ '23S_rRNA' ]

    def has_5s_rrna(self): 
        return self._data[ '5S_rRNA' ]
